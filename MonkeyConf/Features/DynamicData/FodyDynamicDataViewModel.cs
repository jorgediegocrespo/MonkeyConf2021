...
{
	public class FodyDynamicDataViewModel : BaseViewModel
	{
        ...
        public FodyDynamicDataViewModel()
        {
        ...
        [Reactive] public bool Initiated { get; private set; }

        [Reactive] public string SearchText { get; set; }

        [Reactive] public string SortBy { get; set; }

        [Reactive] public List<string> SortByList { get; set; }
